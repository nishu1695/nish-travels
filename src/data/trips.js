...
image: `${import.meta.env.BASE_URL}images/utah/hero.jpg`,
  ...
  tripType: "National Parks Road Trip",
  ...
  the Hickman Bridge hike and I had to run back to the car through the storm.
  `,
  ...
  itinerary: [
    ...
    {
      day: 3,
      title: "The Narrows • Bryce Canyon",
      details: [
        "Zion Visitor Center",
        "Riverside Walk",
        "The Narrows hike",
    ...
    {
      day: 7,
      title: "Goblin Valley • Delicate Arch",
      details: [
    ...
    {
      day: 10,
      title: "Las Vegas Strip • Flight Home",
      details: [
        "Coffee roastery breakfast",
        "The Deuce bus",
        "Bellagio",
        "Cosmopolitan",
        "Sphere",
